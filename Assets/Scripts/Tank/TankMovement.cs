...
public class TankMovement : MonoBehaviour
{
    ...
    public GameObject current_Shield;        
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyUp("b"))
            {
                gameObject.GetComponent<TankHealth>().shield_status = false;
        ...
        if (Input.GetKeyDown("b"))
            {
                ...
                gameObject.GetComponent<TankHealth>().shield_status = true;
                current_Shield.transform.parent = gameObject.transform;
